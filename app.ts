...
bot.command('help', (ctx) => {
  ctx.replyWithMarkdownV2(`I can help you handle NESTFi futures. If you're new to NESTFi, please [see the website](https://nestfi.org).
...
bot.action('logout', async (ctx) => {
  ...
  ctx.reply('You have successfully deleted your NESTFi authorization.')
})
